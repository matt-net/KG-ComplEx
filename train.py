...
def split_train_val(triples, labels, val_ratio=0.2):
...
if __name__ == "__main__":
    ...
    # train_triples, val_triples, train_labels, val_labels = split_train_val(all_triples, all_labels, val_ratio=0.2)
    #
    # # Save each tensor with a descriptive filename (optional)
    # tensors = {
    ...
    model.fit(train_triples, train_labels, val_triples, val_labels, num_entities, batch_size=64, epochs=100, lr=0.001,
              regularization=-1e-7)
